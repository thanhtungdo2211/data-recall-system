...
class DetectionModelErd(DetectionModel):
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True, 
                 t_model_nc=None, t_stride=None, 
                 add_on_indexs=None, ignore_distill_indexes=None):  # model, input channels, number of classes
        super().__init__(cfg, ch, nc, verbose)
        
        self.nc_origin = t_model_nc
        self.t_stride = t_stride
        self.add_on_indexes = add_on_indexs
        self.ignore_distill_indexes = ignore_distill_indexes
...
class SegmentationModelERD(DetectionModelErd):
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True, t_model_nc=None, t_stride=None, 
                 add_on_indexs=None, ignore_distill_indexes=None):
        super().__init__(cfg, ch, nc, verbose, t_model_nc, t_stride, add_on_indexs, ignore_distill_indexes)
